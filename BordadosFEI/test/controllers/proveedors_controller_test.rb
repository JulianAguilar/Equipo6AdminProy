...
class ProveedorsControllerTest < ActionController::TestCase
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post :create, proveedor: { Correo: @proveedor.Correo, Direccion: @proveedor.Direccion, Nombre: @proveedor.Nombre, RFC: @proveedor.RFC, Telefono: @proveedor.Telefono }
    end
  ...
  test "should update proveedor" do
    patch :update, id: @proveedor, proveedor: { Correo: @proveedor.Correo, Direccion: @proveedor.Direccion, Nombre: @proveedor.Nombre, RFC: @proveedor.RFC, Telefono: @proveedor.Telefono }
    assert_redirected_to proveedor_path(assigns(:proveedor))
  end
