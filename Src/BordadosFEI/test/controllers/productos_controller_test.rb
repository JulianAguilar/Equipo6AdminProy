...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { Costo: @producto.Costo, Descripcion: @producto.Descripcion, Nombre: @producto.Nombre }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { Costo: @producto.Costo, Descripcion: @producto.Descripcion, Nombre: @producto.Nombre }
    assert_redirected_to producto_path(assigns(:producto))
  end
