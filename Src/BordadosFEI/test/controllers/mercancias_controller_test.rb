...
class MercanciasControllerTest < ActionController::TestCase
  ...
  test "should create mercancia" do
    assert_difference('Mercancia.count') do
      post :create, mercancia: { Cantidad: @mercancia.Cantidad, Descripcion: @mercancia.Descripcion, Pedido_id: @mercancia.Pedido_id, Producto_id: @mercancia.Producto_id, Terminado: @mercancia.Terminado }
    end
  ...
  test "should update mercancia" do
    patch :update, id: @mercancia, mercancia: { Cantidad: @mercancia.Cantidad, Descripcion: @mercancia.Descripcion, Pedido_id: @mercancia.Pedido_id, Producto_id: @mercancia.Producto_id, Terminado: @mercancia.Terminado }
    assert_redirected_to mercancia_path(assigns(:mercancia))
  end
