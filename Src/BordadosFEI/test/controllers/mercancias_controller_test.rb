...
class MercanciasControllerTest < ActionController::TestCase
  ...
  test "should create mercancia" do
    assert_difference('Mercancia.count') do
      post :create, mercancia: { Cantidad: @mercancia.Cantidad, Descripcion: @mercancia.Descripcion, Nombre: @mercancia.Nombre, Precio: @mercancia.Precio }
    end
  ...
  test "should update mercancia" do
    patch :update, id: @mercancia, mercancia: { Cantidad: @mercancia.Cantidad, Descripcion: @mercancia.Descripcion, Nombre: @mercancia.Nombre, Precio: @mercancia.Precio }
    assert_redirected_to mercancia_path(assigns(:mercancia))
  end
