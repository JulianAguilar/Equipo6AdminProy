...
class ProveedoresControllerTest < ActionController::TestCase
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post :create, proveedor: { Direccion: @proveedor.Direccion, Nombre: @proveedor.Nombre, Producto: @proveedor.Producto, RFC: @proveedor.RFC, Telefono: @proveedor.Telefono }
    end
  ...
  test "should update proveedor" do
    patch :update, id: @proveedor, proveedor: { Direccion: @proveedor.Direccion, Nombre: @proveedor.Nombre, Producto: @proveedor.Producto, RFC: @proveedor.RFC, Telefono: @proveedor.Telefono }
    assert_redirected_to proveedor_path(assigns(:proveedor))
  end
