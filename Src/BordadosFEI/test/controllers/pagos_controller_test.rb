...
class PagosControllerTest < ActionController::TestCase
  ...
  test "should create pago" do
    assert_difference('Pago.count') do
      post :create, pago: { FechaPago: @pago.FechaPago, Pedido_id: @pago.Pedido_id, Subtotal: @pago.Subtotal, Total: @pago.Total }
    end
  ...
  test "should update pago" do
    patch :update, id: @pago, pago: { FechaPago: @pago.FechaPago, Pedido_id: @pago.Pedido_id, Subtotal: @pago.Subtotal, Total: @pago.Total }
    assert_redirected_to pago_path(assigns(:pago))
  end
